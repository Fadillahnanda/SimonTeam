    ...
    <div class="sm-content-wrapper">
      <header class="sm-topbar">
        <div class="header-title">
          <h2>Edit Data Industri</h2>
          <p>Update data pada formulir berikut</p>
        </div>
        ...
        <form @submit.prevent="simpanData">
          <div class="form-grid">
            ...
            <div class="form-group">
              ...
              <input type="text" v-model="siswa.nama" placeholder="Adelia, S.Kom" required />
            </div>
            <div class="form-group">
              <label>Nama Instansi</label>
              <input type="text" v-model="siswa.nama" placeholder="PT. Telkom" required />
            </div>
            ...
            <div class="form-group">
              <label>Kontak</label>
              <input type="text" v-model="siswa.nama" placeholder="1234567890" required />
            </div>

            <div class="form-group">
              <label>Kuota</label>
              <input type="text" v-model="siswa.tempatPkl" placeholder="4" />
            </div>
          </div>
